...
import { Plus, Search, Heart, Layers, GitBranch, Terminal, Filter } from "lucide-react";
      ...
      <div className="flex gap-6 h-[calc(100vh-120px)]">
        ...
        <main className="flex-1 min-w-0 overflow-hidden">
          ...
          <div className="flex gap-2 mb-4 md:hidden">
            ...
            <Button onClick={handleAdd} className="shrink-0 bg-emerald-600 hover:bg-emerald-700">
