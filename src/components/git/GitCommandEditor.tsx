...
import { GitCommand, DifficultyLevel, defaultGitCategories } from "@/types/git";
...
interface GitCommandEditorProps {
  command: GitCommand | null;
  isOpen: boolean;
  onClose: () => void;
  onSave: (command: Omit<GitCommand, "id"> | GitCommand) => void;
  categories: string[];
  onAddCategory: (category: string) => void;
}

const GitCommandEditor = ({
  command,
  isOpen,
  onClose,
  onSave,
        ...
        <div className="grid gap-4 py-4">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="-a (all), -m (message), --amend"
            />
          </div>
...
export default GitCommandEditor;
