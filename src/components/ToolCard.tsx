...
import { ExternalLink, Key, FileSpreadsheet, Braces, GitBranch, Palette, Code2, Server, Terminal, Shapes, Container, FileText, Link, Database, Image, CheckSquare, BookMarked, Settings, Package, Globe, RefreshCw } from "lucide-react";
...
const internalTools = ["licence-key-hub", "domain-hub", "csv-preview-pro", "wp-script-library", "color-palette-gen", "wpcli-glossary", "svg-icon-library", "git-commander", "docker-commander", "code-snippet-library", "wp-hook-reference", "wp-query-builder", "markdown-editor", "image-resizer", "file-converter", "task-reminder", "knowledge-base", "wp-config-generator", "plugin-header-builder"];
